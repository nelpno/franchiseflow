-- =============================================================================
-- FIX: Supabase Security Advisor — 1 Erro + 28 Warnings
-- Data: 2026-03-26
--
-- Corrige:
--   1. 28 funções sem search_path definido (search path injection)
--   2. View vw_dadosunidade com SECURITY DEFINER → SECURITY INVOKER
--
-- Nota: Usa SET search_path = 'public' (não vazio '') porque 26 de 28 funções
-- referenciam tabelas sem qualificação de schema (ex: FROM profiles).
--
-- Rollback: ALTER FUNCTION public.nome() RESET search_path;
-- =============================================================================

-- =============================================
-- PARTE 1: Funções — SET search_path = 'public'
-- =============================================

-- --- Trigger functions (sem parâmetros) ---
ALTER FUNCTION public.audit_sale_delete() SET search_path = 'public';
ALTER FUNCTION public.auto_generate_instance_id() SET search_path = 'public';
ALTER FUNCTION public.auto_link_franchise_func() SET search_path = 'public';
ALTER FUNCTION public.handle_new_user() SET search_path = 'public';
ALTER FUNCTION public.on_franchise_created() SET search_path = 'public';
ALTER FUNCTION public.on_inventory_low_stock() SET search_path = 'public';
ALTER FUNCTION public.on_new_purchase_order() SET search_path = 'public';
ALTER FUNCTION public.on_purchase_order_delivered() SET search_path = 'public';
ALTER FUNCTION public.on_purchase_order_status_change() SET search_path = 'public';
ALTER FUNCTION public.on_sale_created() SET search_path = 'public';
ALTER FUNCTION public.revert_contact_on_sale_delete() SET search_path = 'public';
ALTER FUNCTION public.stock_decrement() SET search_path = 'public';
ALTER FUNCTION public.stock_revert() SET search_path = 'public';
ALTER FUNCTION public.update_contact_on_sale() SET search_path = 'public';
ALTER FUNCTION public.update_updated_at() SET search_path = 'public';

-- --- RLS helper functions ---
ALTER FUNCTION public.is_admin() SET search_path = 'public';
ALTER FUNCTION public.managed_franchise_ids() SET search_path = 'public';

-- --- Functions com parâmetros ---
ALTER FUNCTION public.add_default_product(text, text, text, numeric, integer) SET search_path = 'public';
ALTER FUNCTION public.aggregate_daily_data(date) SET search_path = 'public';
ALTER FUNCTION public.aggregate_daily_data() SET search_path = 'public';
ALTER FUNCTION public.auto_populate_inventory(text) SET search_path = 'public';
ALTER FUNCTION public.deduct_inventory(text, jsonb) SET search_path = 'public';
ALTER FUNCTION public.get_contact_by_phone(text, text) SET search_path = 'public';
ALTER FUNCTION public.get_franchise_ranking(date, text) SET search_path = 'public';
ALTER FUNCTION public.notify_admins(text, text, text, text, text) SET search_path = 'public';
ALTER FUNCTION public.notify_franchise_users(uuid, text, text, text, text, text) SET search_path = 'public';
ALTER FUNCTION public.update_contact_address(uuid, text, text) SET search_path = 'public';
ALTER FUNCTION public.upsert_bot_contact(text, text, text) SET search_path = 'public';

-- =============================================
-- PARTE 2: View vw_dadosunidade — SECURITY INVOKER
-- =============================================
...
SELECT
  ...
  -- Pagamento — campos estruturados (TEXT[])
  ...
  -- Entrega — regras de frete (JSONB nativo)
  CASE
...
COMMENT ON VIEW vw_dadosunidade IS
  'View para vendedor genérico n8n (V2 Supabase). SECURITY INVOKER. '
  'Campos TEXT legados gerados automaticamente dos campos estruturados. '
