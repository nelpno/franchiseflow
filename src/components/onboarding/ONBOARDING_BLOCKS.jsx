export const BLOCKS = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "3-7", label: "8 etiquetas criadas: Contato Novo, Interessado, Pedido Confirmado, Cliente, Cliente Fiel, Clientes Sumidos, Não Fechou, Indicação", role: "franchisee" },
  ...
  },
  {
    ...
    items: [
      ...
      { key: "5-2", label: "Primeiro pedido de reposição realizado pelo app (Gestão → Reposição)", role: "franchisee" },
      ...
      { key: "5-5", label: "Controle de estoque iniciado no app (Gestão → Estoque)", role: "franchisee" },
